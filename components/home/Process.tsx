...
export function Process() {
  return (
    <section id="process" className="bg-[#ffdab9]/30 py-20">
      <Container>
        ...
        <div className="relative">
          <div className="hidden md:block absolute top-10t-[10%] right-[10%] h-px bg-neutral-200" />
            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-white border border-neutral-200 shadow-sm flex items-center justify-center mb-5 relative z-10">
                  <div className="w-14 h-14 rounded-full bg-powder-blush/15 flex items-center justify-center">
                    {step.icon}
                  </div>
                </div>
                <div className="font-heading font-bold text-sm text-light-coral mb-2 w-7 h-7 rounded-full bg-powder-blush/15 flex items-center justify-center">
                  {step.id}
                </div>
