        ...
        <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-8 md:p-12">
          ...
          >
            <Input
              ...
              className="flex-1 h-12 text-base rounded-lg border-neutral-300 focus-visible:ring-light-coral focus-visible:ring-2 px-4"
            />
            <Button
              type="submit"
              disabled={loading}
              className="h-12 px-8 bg-light-coral hover:bg-[#e46d6d] text-white rounded-lg text-base font-semibold shadow-sm transition"
            >
          ...
          {status && (
            <div className="mt-16 relative">
              <div className="flex flex-col md:flex-row justify-between relative max-w-4xl mx-auto px-4 md:px-0">
                <div className="hidden md:block absolute top-6 left-[5%] right-[5%] h-px bg-neutral-200 z-0" />
                <div className="md:hidden absolute top-6 bottom-6 left-7.75 w-px bg-neutral-200 z-0" />
                  ...
                  {STEPS.map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        {isCompleted && index > 0 && (
                          <>
                            <div className="md:hidden absolute -top-6 left-6.75 w-px h-6 bg-light-coral z-0" />
                            <div className="hidden md:block absolute top-6 -left-[50%] w-full h-px bg-light-coral z-0" />
                          </>
                        )}
                        <div
                          className={`w-12 h-12 rounded-full border-2 flex items-center justify-center font-bold text-sm transition-all duration-500 relative z-10 ${isCompleted ? "bg-light-coral border-light-coral text-white" : "bg-white border-neutral-300 text-neutral-400"}`}
                        >
                          {isCompleted ? (
